...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
              <!--  <div class="card-header">{{ __('add a club') }}</div> -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <!--<div class="card-header">{{ __('add a room') }}</div>-->
                ...
                <div class="card-body card-body-costum">
                    ...
                    <form method="POST" action="/rooms">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="block" type="text" class="form-control @error('block') is-invalid @enderror" name="block" value="{{ old('block') }}" required autocomplete="block">
